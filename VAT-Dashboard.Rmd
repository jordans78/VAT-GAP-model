...
t_df1 %>% plot_ly(labels = ~variable, values = ~value, type = "pie", 
...
plot_ly(data = t_df1, labels = ~variable, values = ~value, type = "pie",
...
# FINAL_CENTILE_PLOT1<-data.frame(vat_effective_final, grp_id=NA, grp_label=NA)
#   
#             for (i in 1:length((vat_effective_final$centiles)))
#           {
#             if (vat_effective_final$centiles[i]<=50)
#             {
#               FINAL_CENTILE_PLOT1$grp_label[i] <- "<=50%"
#               FINAL_CENTILE_PLOT1$grp_id[i] <- 1
#             }
#             else if (51<=vat_effective_final$centiles[i] &vat_effective_final$centiles[i]<=60)
#             {
#               FINAL_CENTILE_PLOT1$grp_label[i] <- "51%-60%"
#               FINAL_CENTILE_PLOT1$grp_id[i] <- 2
#             }
#             else if (61<=vat_effective_final$centiles[i] & vat_effective_final$centiles[i]<=70)
#             {
#               FINAL_CENTILE_PLOT1$grp_label[i] <- "61%-70%"
#               FINAL_CENTILE_PLOT1$grp_id[i] <- 3
#             }
#             else if (71<=vat_effective_final$centiles[i] & vat_effective_final$centiles[i]<=80)
#             {
#               FINAL_CENTILE_PLOT1$grp_label[i] <- "71%-80%"
#               FINAL_CENTILE_PLOT1$grp_id[i] <- 4
#             }
#             else if (81<=vat_effective_final$centiles[i] & vat_effective_final$centiles[i]<=90)
#             {
#               FINAL_CENTILE_PLOT1$grp_label[i] <- "81%-90%"
#               FINAL_CENTILE_PLOT1$grp_id[i] <- 5
#             }
#             else if (90<=vat_effective_final$centiles[i] & vat_effective_final$centiles[i]<=98)
#             {
#               FINAL_CENTILE_PLOT1$grp_label[i] <- "91%-98%"
#               FINAL_CENTILE_PLOT1$grp_id[i] <- 6
#             }
#             else if (vat_effective_final$centiles[i]==99)
#             {
#               FINAL_CENTILE_PLOT1$grp_label[i] <- "=99%"
#               FINAL_CENTILE_PLOT1$grp_id[i] <- 7
#             }
#             else
#             {
#               FINAL_CENTILE_PLOT1$grp_label[i] <- ">99%"
#               FINAL_CENTILE_PLOT1$grp_id[i] <- 8
#             }
#           }
# 
#           FINAL_CENTILE_PLOT1$grp_label<-factor(FINAL_CENTILE_PLOT1$grp_label)
#          color_code<-factor(c(rep("dark orange2", 6), "forest green", "dodgerblue4"))
# 
#           means_g4<-data.frame(ddply(FINAL_CENTILE_PLOT1,~grp_id+grp_label,summarise,mean=mean(effective_vat_before_reform),sd=sd(effective_vat_before_reform)), color_code)
# 
